...
git checkout -f -b push-action/temporary/${GITHUB_RUN_ID}
git push -f https://${INPUT_GITHUB_TOKEN}@github.com/${INPUT_REPOSITORY}.git
...
git merge --ff-only origin/push-action/temporary/${GITHUB_RUN_ID}
git push
